...
INSERT INTO `vhosts` VALUES ('w3.myvhost1.net', NULL, 'yes', '/usr/local/www/vhosts/01', 'www@vhost1.net', 'enable_dl=0;default_charset=koi8-r');
INSERT INTO `vhosts` VALUES ('www.myvhost2.net', 'myvhost2.net','yes', '/usr/local/www/vhosts/02', 'www@vhost2.net', 'default_charset=koi8-r');
